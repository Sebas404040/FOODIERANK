...
import { getRestaurantes, postRestaurante, deleteRestaurante, patchRestaurante, getRestaurantePorId } from "../controllers/restaurantes.controller.js";
import { autenticacionMidleware } from "../middelewares/authenticationMiddleware.js";

const router = Router();

router.get("/", getRestaurantes);
router.get("/:id", getRestaurantePorId);
