...
router.post("/", autenticacionMidleware, createPlatoDTO, validationDTO, postPlato);
router.delete("/:id", deletePlato);
router.patch("/:id", autenticacionMidleware, updatePlatoDTO, validationDTO, patchPlato);
