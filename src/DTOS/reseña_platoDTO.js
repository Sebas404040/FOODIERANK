...
export const createReseñaPlatoDTO = [
    body('id').notEmpty().withMessage('El id de la reseña es obligatorio.').isNumeric().withMessage('El id de la reseña debe ser un valor numérico.'),
    body('platoId').notEmpty().withMessage('El id del plato es obligatorio.').isNumeric().withMessage('El id del plato debe ser un valor numérico.'),
...
export const updateReseñaPlatoDTO = [
