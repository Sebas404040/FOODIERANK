...
export const createPlatoDTO = [
    ...
    body('id_restaurante').notEmpty().withMessage('El id del restaurante es obligatorio.').isNumeric().withMessage('El id del restaurante debe ser un valor numérico.').toInt()
];
...
export const updatePlatoDTO = [
    ...
    body('id_restaurante').optional().isNumeric().withMessage('El id del restaurante debe ser un valor numérico.').toInt()
];